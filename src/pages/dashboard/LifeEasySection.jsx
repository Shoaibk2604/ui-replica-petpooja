    ...
    <section className="w-full overflow-hidden text-white">
      <div className="relative">
        <div className="relative mx-auto max-w-[1320px] px-4 py-20">
          <h2 className="text-white text-center mb-10 md:mb-20 leading-[1.25] md:text-[65px] text-[34px] font-medium sm:font-semibold">
          ...
          <div className="mt-14 grid gap-0  md:grid-cols-[65%_35%]">
            <div className="relative overflow-hidden border-y-[0.92px] md:border-l-[0.92px] border-[#00874533] p-8 ">
              ...
              <div className="relative flex flex-col-reverse md:block">
                <div className="mb-12">
                  <h6 className="md:text-[30px] text-[20px] font-semibold sm:text-2xl mb-6 text-center md:text-left">
                    Provide clear project briefs
                  </h6>
                  <p className="text-white/70 feature-p leading-[1.25] text-center md:text-[17px] text-[14px] md:text-left max-w-[430px]">
                ...
                <div className="flex justify-center">
                  <img
                    ...
                    className="mb-8 h-auto w-full max-w-[360px] md:mb-0 md:mt-8"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="relative overflow-hidden border  border-[#00874533] border-r-0 bg-black/25 p-8 shadow-[0_25px_80px_rgba(0,0,0,0.55)]">
              ...
              <div className="relative flex h-full flex-col justify-between">
                ...
                <div className="mt-10">
                  ...
                  <p className="text-white/70 feature-p leading-[1.25] text-center text-[14px] md:text-[17px] md:text-left max-w-[430px]">
          ...
          <div className="grid gap-0  md:grid-cols-[35%_65%]">
            <div className="relative overflow-hidden  border border-[#00874533] border-l-0 bg-black/25 p-8 shadow-[0_25px_80px_rgba(0,0,0,0.55)]">
              ...
              <div className="relative flex flex-col-reverse md:block">
                ...
                <img
                  src={card3}
                  alt="Languages card"
                  className="w-full h-full object-contain mx-auto mb-6 md:mb-0 gm-lazy gm-loaded gm-observing gm-observing-cb"
                />
              </div>
            </div>
            ...
            <div className="relative overflow-hidden border border-[#00874533] border-r-0 p-8 shadow-[0_25px_80px_rgba(0,0,0,0.55)]">
              ...
              <div className="relative">
                ...
                />
                <div>
                  <h6 className="md:text-[30px] text-[20px] font-semibold sm:text-2xl mb-6 mt-6 text-center md:text-left">
            ...
            <div className="relative overflow-hidden border border-[#00874533] border-x-0 p-8 shadow-[0_25px_80px_rgba(0,0,0,0.55)] md:col-span-2">
              ...
              <div className="relative grid gap-8 md:grid-cols-5 md:items-center">
                <div className="md:col-span-3 order-2 md:order-1">
                  ...
                  <p className="text-white/70 feature-p leading-[1.25] text-center text-[14px] md:text-[17px] md:text-left max-w-[630px]">
